...
public class Background
{
	...
	public void scroll(int scrollSpeed)
	{
		...
		if (this.wallpaper.getYCenter() >= this.RES_Y + this.RES_Y/2)
			this.wallpaper.translateTo(this.RES_X/2, -this.RES_Y/2);
		if (this.wallpaper2.getYCenter() >= this.RES_Y + this.RES_Y/2)
			this.wallpaper2.translateTo(this.RES_X/2, -this.RES_Y/2);
	}
}
