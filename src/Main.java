...
public class Main {
	...
	/* 
	 * int lowerBound: sets the lowest amount from the top of the screen a platform can appear
	 * int upperBound: sets the highest amount from the top of the screen a platform can appear
	 */
	{
	...
	/*
	 * int i: the index in the platforms array the platform to be closed is located at
	 */
	{
